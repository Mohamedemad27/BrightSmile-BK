...
from .views import (
    ...
    PaymentCheckoutSessionCreateView,
...
urlpatterns = [
    ...
    path('payments/checkout-session/', PaymentCheckoutSessionCreateView.as_view(), name='payment_checkout_session'),
    path('payments/methods/', PaymentMethodListCreateView.as_view(), name='payment_methods'),
    path('payments/methods/<uuid:method_id>/', PaymentMethodDetailView.as_view(), name='payment_method_detail'),
    path('payments/preferences/', PaymentPreferenceView.as_view(), name='payment_preferences'),
    path('payments/transactions/<uuid:transaction_id>/', PaymentTransactionStatusView.as_view(), name='payment_transaction_status'),
]
