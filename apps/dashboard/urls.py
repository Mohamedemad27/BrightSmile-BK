...
urlpatterns = [
    ...
    path('admin/doctors/<uuid:pk>/decline/', AdminDoctorDeclineView.as_view(), name='admin-doctor-decline'),
    path('admin/doctors/<uuid:pk>/profile/', AdminDoctorProfileUpdateView.as_view(), name='admin-doctor-profile-update'),
    ...
    path('admin/health-tips/<uuid:pk>/', AdminHealthTipDetailView.as_view(), name='admin-health-tip-detail'),
    ...
    path('admin/syndicate/sync/', AdminSyndicateSyncView.as_view(), name='admin-syndicate-sync'),
